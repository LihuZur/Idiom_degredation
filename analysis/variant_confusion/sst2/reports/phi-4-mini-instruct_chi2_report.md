...
- observed diff (b - c) = 0
- 95% bootstrap CI = [-17, 17]
- bootstrap p-value = 1.00000 (n_boot=10000)
...
The bootstrap check is **more cautious**: its 95% CI on (idiomatic_only minus paraphrase_only) is [-17, 17] (includes zero), and its empirical p-value is 1.00000. This is broadly consistent with the McNemar result above.
