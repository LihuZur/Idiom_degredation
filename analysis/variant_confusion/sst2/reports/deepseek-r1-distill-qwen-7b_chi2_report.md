...
- 95% bootstrap CI = [-11, 38]
- bootstrap p-value = 0.31080 (n_boot=10000)
...
The bootstrap check is **more cautious**: its 95% CI on (idiomatic_only minus paraphrase_only) is [-11, 38] (includes zero), and its empirical p-value is 0.31080. This is broadly consistent with the McNemar result above.
